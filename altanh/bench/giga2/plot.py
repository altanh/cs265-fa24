...
if __name__ == "__main__":
    ...
    rotate_giga = df[df.run == "rotate-giga"].result
    rotate_giga = geometric_mean(rotate_giga)

    print(f"Giga: {giga} ({1 / giga}x speedup)")
    print(f"Rotate Giga: {rotate_giga} ({1 / rotate_giga}x speedup)")
